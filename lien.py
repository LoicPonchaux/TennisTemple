...
class Lien():
    ...
    def nombre_de_page (self, nb):
        self.nb_page = nb

    def get_nb_page(self):
        return  self.nb_page

    def ajout_date_jouralier (self, date):
        self.date_jour = date

    def ajout_date_semaine (self, date):
        self.date_semaine = date

    def recuperation_lien_journalier(self):
        return self.lien_jour+str(self.date_jour)

    def recuperation_lien_hebdo(self):
        return self.lien_hebdo+str(self.date_semaine)

    def recuperation_liens (self, type):
        tab = []
        if (type == "J"):
